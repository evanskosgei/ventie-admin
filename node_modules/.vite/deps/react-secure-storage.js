    ...
    var getDisabledKeys = function getDisabledKeys2() {
      ...
      DISABLED_KEYS.split("|").forEach(function(key) {
        if (key === "") {
          ...
          console.warn("react-secure-storage : ".concat(key, " is not present in the available disabled keys options! Please go through the documentation"));
      });
      return response;
    };
    ...
    var SecureLocalStorage = function() {
      ...
      _createClass(SecureLocalStorage2, [{
        ...
        value: function removeItem(key) {
          ...
          var parsedKeyLocal = getLocalKey(key, value);
          if (this._localStorageItems[parsedKey] !== void 0)
