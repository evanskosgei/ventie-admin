    ...
    (function(global2, factory) {
      ...
      var Enumerator = function() {
        ...
        Enumerator2.prototype._enumerate = function _enumerate(input2) {
          for (var i2 = 0; this._state === PENDING && i2 < input2.length; i2++) {
            this._eachEntry(input2[i2], i2);
          }
        };
...
var CoreFeature, Module, Helpers, defautlAccessors, Accessor, defaultConfig, defaultContentTypeFormatters, Ajax, defaultPasteActions, defaultPasteParsers, Clipboard, CalcComponent, CellComponent, Cell, ColumnComponent, defaultColumnOptions, Column$1, RowComponent$1, Row, defaultCalculations, ColumnCalcs, DataTree, defaultDownloaders, Download, defaultEditors, Edit, ExportRow, ExportColumn, Export, defaultFilters, Filter, defaultFormatters, Format, FrozenColumns, FrozenRows, GroupComponent, Group, GroupRows, defaultUndoers, defaultRedoers, History, HtmlTableImport, Interaction, defaultBindings, defaultActions, Keybindings, Menu, MoveColumns, MoveRows, defaultMutators, Mutator, Page, defaultReaders, defaultWriters, Persistence, Print, ReactiveData, ResizeColumns, ResizeRows, ResizeTable, ResponsiveLayout, SelectRow, defaultSorters, Sort, defaultValidators, Validate, modules, defaultOptions, OptionsList, Renderer, BaiscHorizontal, VirtualDomHorizontal, ColumnManager, BaiscVertical, VirtualDomVertical, RowManager, FooterManager, InteractionManager, ComponentFunctionBinder, DataLoader, ExternalEventBus, InternalEventBus, TableRegistry, defaultModes, Layout, defaultLangs, Localize, Comms, coreModules, ModuleBinder, Tabulator, TabulatorFull, PseudoRow;
var init_tabulator_esm = __esm({
  "node_modules/tabulator-tables/dist/js/tabulator_esm.js"() {
    ...
    Ajax = class _Ajax extends Module {
      ...
      _loadDefaultConfig(force) {
        if (!this.config || force) {
          this.config = {};
          for (let key in _Ajax.defaultConfig) {
            this.config[key] = _Ajax.defaultConfig[key];
          }
        }
      }
      //set request url
    ...
    Column$1 = class _Column$1 extends CoreFeature {
      constructor(def, parent) {
        ...
        if (this.definition.columns) {
          ...
          this.definition.columns.forEach((def2, i2) => {
            var newCol = new _Column$1(def2, this);
      ...
      mapDefinitions() {
        ...
        this.definition = this.table.columnManager.optionsList.generate(_Column$1.defaultOptionList, this.definition);
      }
      checkDefinition() {
        Object.keys(this.definition).forEach((key) => {
          if (_Column$1.defaultOptionList.indexOf(key) === -1) {
    ...
    Edit = class _Edit extends Module {
      constructor(table2) {
        super(table2);
    ...
    Keybindings = class _Keybindings extends Module {
      ...
      initialize() {
        ...
        this.pressedKeys = [];
        if (bindings !== false) {
          for (let key in _Keybindings.bindings) {
            mergedBindings[key] = _Keybindings.bindings[key];
          }
    ...
    BaiscHorizontal = class extends Renderer {
      constructor(table2) {
        super(table2);
      }
      renderRowCells(row2) {
          ...
          rows.forEach((row2) => {
            ...
            if (row2.type !== "group") {
              ...
              if (cell) {
                el = cell.getElement();
                if (el.parentNode) {
                  row2.getElement().removeChild(el);
                }
              }
            }
          });
    ...
    BaiscVertical = class extends Renderer {
      constructor(table2) {
        super(table2);
    ...
    TableRegistry = class _TableRegistry {
      static register(table2) {
        _TableRegistry.tables.push(table2);
      }
      static deregister(table2) {
        var index = _TableRegistry.tables.indexOf(table2);
        if (index > -1) {
        ...
        if (typeof query === "string") {
          ...
          if (matches.length) {
            for (var i2 = 0; i2 < matches.length; i2++) {
              match = _TableRegistry.matchElement(matches[i2]);
              if (match) {
                results.push(match);
              }
            }
      ...
      static matchElement(element) {
        return _TableRegistry.tables.find(function(table2) {
    ...
    Layout = class _Layout extends Module {
      ...
      layout() {
        _Layout.modes[this.mode].call(this, this.table.columnManager.columnsByIndex);
...
var require_ReactTabulator = __commonJS({
  "node_modules/react-tabulator/lib/ReactTabulator.js"(exports) {
    ...
    var ReactTabulator = function(props) {
      ...
      var _a = React.useState("tabulator-".concat(+/* @__PURE__ */ new Date(), "-").concat(Math.floor(Math.random() * 9999999))), mainId = _a[0], setMainId = _a[1];
      var htmlProps;
      htmlProps = (0, pick_react_known_prop_1.pickHTMLProps)(props);
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                ...
                return [4, (0, ConfigUtils_1.propsToOptions)(props)];
              case 1:
                propOptions = _b.sent();
                if (data) {
...
var require_Utils = __commonJS({
  "node_modules/react-tabulator/lib/Utils.js"(exports) {
    ...
    function isSameArray(a, b) {
      var i2 = a && a.length ? a.length : 0;
      if (i2 !== (b && b.length ? b.length : 0)) {
        return false;
      }
      while (i2--) {
        if (a[i2] !== b[i2]) {
    ...
    function stringifyCensor(censor) {
      ...
      return function(key, value) {
        if (i2 !== 0 && typeof censor === "object" && typeof value == "object" && censor == value) {
          return "[Circular]";
        }
        if (i2 >= 29) {
          return "[Unknown]";
    ...
    var default_1 = (
      ...
      function(_super) {
        ...
        function default_12() {
          ...
          _this.mainId = "tabulator-".concat(+/* @__PURE__ */ new Date(), "-").concat(Math.floor(Math.random() * 9999999));
          _this.table = null;
          _this.pickValidHTMLProps = function() {
            if (!_this.htmlProps) {
              _this.htmlProps = (0, pick_react_known_prop_1.pickHTMLProps)(_this.props);
            ...
            return __generator(this, function(_b) {
              switch (_b.label) {
                case 0:
                  ...
                  return [4, (0, ConfigUtils_1.propsToOptions)(this.props)];
                case 1:
                  propOptions = _b.sent();
    ...
    function parse(dateStr, format2, i18n) {
      ...
      newFormat = regexEscape(newFormat).replace(token, function($0) {
        ...
        if (specifiedFields[field2]) {
          throw new Error("Invalid format. ".concat(field2, " specified twice in format"));
        }
      ...
      Object.keys(requiredFields).forEach(function(field2) {
        if (!specifiedFields[field2]) {
          throw new Error("Invalid format. ".concat(field2, " is required in specified format"));
        }
      });
...
var require_DateEditor = __commonJS({
  "node_modules/react-tabulator/lib/editors/DateEditor.js"(exports) {
    ...
    var Editor = (
      ...
      function(_super) {
        ...
        function Editor2() {
          ...
          _this.setValueOnSuccess = function(value) {
            ...
            try {
              ...
              result = (0, DateEditorUtils_1.format)(/* @__PURE__ */ new Date(), DEFAULT_DATE_INPUT_FORMAT);
            }
            success(result);
          };
          ...
          _this.onKeyPress = function(ev) {
            ...
            if (ev.keyCode === 13) {
              var today = (0, DateEditorUtils_1.format)(/* @__PURE__ */ new Date(), DEFAULT_DATE_INPUT_FORMAT);
        ...
        Editor2.prototype.render = function() {
          ...
          var value = (0, DateEditorUtils_1.format)(/* @__PURE__ */ new Date(), DEFAULT_DATE_INPUT_FORMAT);
          try {
    ...
    function default_1(cell, onRendered, success, cancel, editorParams) {
      ...
      (0, react_dom_1.render)(React.createElement(Editor, { cell, onRendered, success, cancel, editorParams }), container);
      return container;
    }
    exports["default"] = default_1;
  }
  ...
  "node_modules/react-tabulator/node_modules/react-tag-autocomplete/dist-es6/Suggestions.js"(exports, module) {
    ...
    var Suggestions = class extends React.Component {
      ...
      render() {
        ...
        const options = this.state.options.map((item, i2) => {
          const key = `${this.props.listboxId}-${i2}`;
          const classNames = [];
          if (this.props.selectedIndex === i2) {
  ...
  "node_modules/react-tabulator/node_modules/react-tag-autocomplete/dist-es6/ReactTags.js"(exports, module) {
    ...
    var ReactTags = class extends React.Component {
      ...
      handleDeleteTag(index, event2) {
        if (this.container.current) {
          ...
          const currentEl = Array.prototype.findIndex.call(interactiveEls, (element) => {
            return element === event2.currentTarget;
          });
      ...
      render() {
        ...
        const tags = this.props.tags.map((tag, i2) => React.createElement(TagComponent, {
          key: i2,
          tag,
          classNames: this.state.classNames,
          onDelete: this.handleDeleteTag.bind(this, i2)
        }));
    ...
    var Editor = (
      ...
      function(_super) {
        ...
        function Editor2() {
          ...
          _this.handleDelete = function(i2) {
...
var require_ReactTabulatorExample = __commonJS({
  "node_modules/react-tabulator/lib/ReactTabulatorExample.js"(exports) {
    ...
    exports["default"] = function() {
      ...
      var ref = React.useRef();
      var rowClick = function(e, row2) {
        console.log("ref table: ", ref.current);
        console.log("rowClick id: ${row.getData().id}", row2, e);
        setState({ selectedName: row2.getData().name });
      };
