      ...
      */
      ...
      editList: function(command, selectedCells, detach) {
        ...
        if (isRemove && (!topEl || (firstSel.tagName !== topEl.tagName || command !== topEl.tagName.toUpperCase())) && (!bottomEl || (lastSel.tagName !== bottomEl.tagName || command !== bottomEl.tagName.toUpperCase()))) {
          ...
          if (!cancel)
            tempList = util2.createElement(command);
        ...
        if (remove) {
          ...
          for (let r = 0, rLen = removeCell.length, row; r < rLen; r++) {
            ...
            if (row.cells.length === 0) {
              if (!removeFirst)
                removeFirst = util2.getArrayIndex(rows, row);
  ...
  const core = {
      ...
      try {
        if (!insertListCell) {
          ...
          if (util2.isWysiwygDiv(parentNode) && (oNode.nodeType === 3 || util2.isBreak(oNode))) {
            const fNode = util2.createElement(options.defaultTag);
        ...
        if (!util2.isComponent(oNode)) {
          ...
          if (oNode.nodeType === 3) {
            ...
            const previousText = !previous || previous.nodeType === 1 || util2.onlyZeroWidthSpace(previous) ? "" : previous.textContent;
            const nextText = !next || next.nodeType === 1 || util2.onlyZeroWidthSpace(next) ? "" : next.textContent;
            if (previous && previousText.length > 0) {
              oNode.textContent = previousText + oNode.textContent;
              util2.removeItem(previous);
            }
    ...
    _makeLine: function(node, requireFormat) {
      ...
      if (node.nodeType === 1) {
        ...
        if (!requireFormat || (util2.isFormatElement(node) || util2.isRangeFormatElement(node) || util2.isComponent(node) || util2.isMedia(node) || util2.isAnchor(node) && util2.isMedia(node.firstElementChild))) {
    ...
    _cleanStyle: function(m, v, name2) {
      ...
      if (/span/i.test(name2) && !sv && (m.match(/<span\s(.+)/) || [])[1]) {
        ...
        if (style) {
          ...
          for (let i = 0, len = style.length, r; i < len; i++) {
            ...
            if (r && !/inherit|initial|revert|unset/i.test(r[3])) {
              ...
              const v2 = this.wwComputedStyle[k].replace(/"/g, "");
              const c = r[3].trim();
              switch (k) {
                case "fontFamily":
    ...
    convertContentsForEditor: function(contents) {
      ...
      for (let i = 0, t; i < domTree.length; i++) {
        ...
        if (!util2.isFormatElement(t) && !util2.isRangeFormatElement(t) && !util2.isComponent(t) && !util2.isMedia(t) && t.nodeType !== 8 && !/__se__tag/.test(t.className)) {
          if (!p)
    ...
    _setDefaultFormat: function(formatName) {
      ...
      focusNode = util2.getEdgeChildNodes(commonCon, commonCon);
      focusNode = focusNode ? focusNode.ec : commonCon;
      format = util2.getFormatElement(focusNode, null);
      if (!format) {
        this.removeRange();
        this._editorRange();
        return;
            ...
            if (formatEndEdge && (/^H[1-6]$/i.test(formatEl.nodeName) || /^HR$/i.test(formatEl.nodeName))) {
              ...
              if ((range2.commonAncestorContainer.nodeType === 3 ? !range2.commonAncestorContainer.nextElementSibling : true) && util2.onlyZeroWidthSpace(formatEl.innerText.trim()) && !util2.isListCell(formatEl.nextElementSibling)) {
                ...
                if (util2.isListCell(rangeEl.parentNode)) {
                  ...
                  newEl = util2.splitElement(formatEl, null, util2.getElementDepth(formatEl) - 2);
                  if (!newEl) {
