...
var areaSum, areaRingSum, x00, y00, x0, y0, areaStream, area_default;
var init_area = __esm({
  "node_modules/d3-geo/src/path/area.js"() {
    init_src2();
    init_math();
...
var x02, y02, x1, y1, boundsStream, bounds_default;
...
var X0, Y0, Z0, X1, Y1, Z1, X2, Y2, Z2, x002, y002, x03, y03, centroidStream, centroid_default;
var init_centroid = __esm({
  "node_modules/d3-geo/src/path/centroid.js"() {
    ...
    centroid_default = centroidStream;
  }
});
...
var lengthSum, lengthRing, x003, y003, x04, y04, lengthStream, measure_default;
...
function areaRingEnd2() {
  areaPoint2(lambda00, phi00);
}
function areaPointFirst2(lambda, phi) {
  areaStream2.point = areaPoint2;
  lambda00 = lambda, phi00 = phi;
  lambda *= radians, phi *= radians;
  lambda0 = lambda, cosPhi0 = cos(phi = phi / 2 + quarterPi), sinPhi0 = sin(phi);
}
function areaPoint2(lambda, phi) {
  lambda *= radians, phi *= radians;
  phi = phi / 2 + quarterPi;
  var dLambda = lambda - lambda0, sdLambda = dLambda >= 0 ? 1 : -1, adLambda = sdLambda * dLambda, cosPhi = cos(phi), sinPhi = sin(phi), k = sinPhi0 * sinPhi, u = cosPhi0 * cosPhi + k * cos(adLambda), v = k * sdLambda * sin(adLambda);
  areaRingSum2.add(atan2(v, u));
  lambda0 = lambda, cosPhi0 = cosPhi, sinPhi0 = sinPhi;
}
function area_default2(object2) {
  areaSum2 = new Adder();
  stream_default(object2, areaStream2);
  return areaSum2 * 2;
}
var areaRingSum2, areaSum2, lambda00, phi00, lambda0, cosPhi0, sinPhi0, areaStream2;
var init_area2 = __esm({
  "node_modules/d3-geo/src/area.js"() {
    ...
    areaStream2 = {
      ...
      polygonEnd: function() {
        var areaRing = +areaRingSum2;
        areaSum2.add(areaRing < 0 ? tau + areaRing : areaRing);
...
function centroidPoint2(lambda, phi) {
  lambda *= radians, phi *= radians;
  var cosPhi = cos(phi);
...
function centroidLineStart2() {
  centroidStream2.point = centroidLinePointFirst;
}
function centroidLinePointFirst(lambda, phi) {
  lambda *= radians, phi *= radians;
  var cosPhi = cos(phi);
  x05 = cosPhi * cos(lambda);
  y05 = cosPhi * sin(lambda);
  z0 = sin(phi);
  centroidStream2.point = centroidLinePoint;
  centroidPointCartesian(x05, y05, z0);
}
function centroidLinePoint(lambda, phi) {
  lambda *= radians, phi *= radians;
  var cosPhi = cos(phi), x = cosPhi * cos(lambda), y = cosPhi * sin(lambda), z = sin(phi), w = atan2(sqrt((w = y05 * z - z0 * y) * w + (w = z0 * x - x05 * z) * w + (w = x05 * y - y05 * x) * w), x05 * x + y05 * y + z0 * z);
  W1 += w;
  X12 += w * (x05 + (x05 = x));
  Y12 += w * (y05 + (y05 = y));
  Z12 += w * (z0 + (z0 = z));
...
function centroidRingStart2() {
  centroidStream2.point = centroidRingPointFirst;
}
...
function centroidRingPointFirst(lambda, phi) {
  ...
  lambda *= radians, phi *= radians;
  centroidStream2.point = centroidRingPoint;
  var cosPhi = cos(phi);
  x05 = cosPhi * cos(lambda);
  y05 = cosPhi * sin(lambda);
  z0 = sin(phi);
...
function centroidRingPoint(lambda, phi) {
  lambda *= radians, phi *= radians;
  var cosPhi = cos(phi), x = cosPhi * cos(lambda), y = cosPhi * sin(lambda), z = sin(phi), cx = y05 * z - z0 * y, cy = z0 * x - x05 * z, cz = x05 * y - y05 * x, m = hypot(cx, cy, cz), w = asin(m), v = m && -w / m;
  X22.add(v * cx);
  Y22.add(v * cy);
  Z22.add(v * cz);
  W1 += w;
...
function centroid_default2(object2) {
  W0 = W1 = X02 = Y02 = Z02 = X12 = Y12 = Z12 = 0;
  X22 = new Adder();
  Y22 = new Adder();
  Z22 = new Adder();
  stream_default(object2, centroidStream2);
  var x = +X22, y = +Y22, z = +Z22, m = hypot(x, y, z);
  if (m < epsilon2) {
    x = X12, y = Y12, z = Z12;
    if (W1 < epsilon)
      x = X02, y = Y02, z = Z02;
...
var W0, W1, X02, Y02, Z02, X12, Y12, Z12, X22, Y22, Z22, lambda003, phi003, x05, y05, z0, centroidStream2;
...
function lengthLineStart() {
  ...
  lengthStream2.lineEnd = lengthLineEnd;
}
function lengthLineEnd() {
  lengthStream2.point = lengthStream2.lineEnd = noop;
}
...
function lengthPoint2(lambda, phi) {
  ...
  lengthSum2.add(atan2(sqrt(x * x + y * y), z));
  lambda03 = lambda, sinPhi02 = sinPhi, cosPhi02 = cosPhi;
}
function length_default(object2) {
  lengthSum2 = new Adder();
  stream_default(object2, lengthStream2);
  return +lengthSum2;
}
var lengthSum2, lambda03, sinPhi02, cosPhi02, lengthStream2;
...
//# sourceMappingURL=chunk-KLLMOHID.js.map
