											...
											<div className="grid grid-cols-12 gap-4">
												...
												<div className="col-span-12 lg:col-span-6">
													<div className="space-y-2  product-1 published-date">
														...
														<div className="flex rounded-sm shadow-sm">
															...
															<DatePicker className="ti-form-input rounded-l-none rtl:rounded-l-sm rtl:rounded-r-none focus:z-10" selected={startDate} onChange={(date) => setStartDate(date)} locale="en-GB" showTimeSelect timeFormat="p" timeIntervals={15} dateFormat="Pp" />
														</div>
													</div>
												</div>
												<div className="col-span-12 lg:col-span-6">
												...
												<div className="col-span-12 lg:col-span-4">
													<div className="space-y-2">
														...
														<input type="text" className="my-auto ti-form-input" classnameprefix="react-select"  placeholder="$550" defaultValue="$550" />
													</div>
												</div>
												<div className="col-span-12 lg:col-span-4">
													<div className="space-y-2">
