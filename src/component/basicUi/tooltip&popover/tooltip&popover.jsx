							...
							<div className="grid grid-cols-3 gap-y-4 gap-x-2 max-w-[15rem] mx-auto">
								<div className="col-start-2 text-center">
									<div className="hs-tooltip ti-main-tooltip">
										<button type="button" className="hs-tooltip-toggle w-10 h-10 ti-btn rounded-full p-0 transition-none focus:outline-none bg-gray-50 border-gray-200 text-gray-600 hover:bg-primary/30 hover:border-primary hover:text-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white">
											<svg className="w-2.5 h-2.5" width="16" height="16" viewBox="0 0 16 16" fill="none">
												<path d="M2.27921 10.64L7.92565 4.99357C8.12091 4.79831 8.4375 4.79831 8.63276 4.99357L14.2792 10.64" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path>
											</svg>
								...
								<div className="col-start-3">
									<div className="hs-tooltip ti-main-tooltip [--placement:right]">
										<button type="button" className="hs-tooltip-toggle w-10 h-10 ti-btn rounded-full p-0 transition-none focus:outline-none bg-gray-50 border-gray-200 text-gray-600 hover:bg-primary/30 hover:border-primary hover:text-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white">
											<svg className="w-2.5 h-2.5" width="16" height="16" viewBox="0 0 16 16" fill="none">
												<path d="M5.27921 2L10.9257 7.64645C11.1209 7.84171 11.1209 8.15829 10.9257 8.35355L5.27921 14" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path>
											</svg>
											<span className="hs-tooltip-content ti-main-tooltip-content py-1 px-2 bg-gray-900 text-xs font-medium text-white shadow-sm dark:bg-slate-700" role="tooltip">
                                  Tooltip on right
											</span>
								...
								<div className="col-start-2 text-center">
									<div className="hs-tooltip ti-main-tooltip [--placement:bottom]">
										<button type="button" className="hs-tooltip-toggle w-10 h-10 ti-btn rounded-full p-0 transition-none focus:outline-none bg-gray-50 border-gray-200 text-gray-600 hover:bg-primary/30 hover:border-primary hover:text-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white">
											<svg className="w-2.5 h-2.5" width="16" height="16" viewBox="0 0 16 16" fill="none">
												<path d="M2.27921 4.64001L7.92565 10.2865C8.12091 10.4817 8.4375 10.4817 8.63276 10.2865L14.2792 4.64001" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path>
											</svg>
											<span className="hs-tooltip-content ti-main-tooltip-content py-1 px-2 bg-gray-900 text-xs font-medium text-white shadow-sm dark:bg-slate-700" role="tooltip">
                                  Tooltip on bottom
											</span>
