          ...
          <div className="box">
            ...
            <div className="box-body">
              <nav className="sm:flex space-x-6 rtl:space-x-reverse">
                <Link className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" to="#">
                  Link
                </Link>
                <Link className="px-1 inline-flex items-center gap-2 text-sm font-medium whitespace-nowrap text-primary hover:text-primary" to="#" aria-current="page">
                  Active
                </Link>
                <Link className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" to="#">
                  Link
                </Link>
                <Link className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-gray-400 pointer-events-none dark:text-white/50" to="#">
                  Disabled
                </Link>
              </nav>
            </div>
          ...
          <div className="box">
            ...
            <div className="box-body">
              <ul className="list-disc space-x-6 rtl:space-x-reverse">
                <li className="inline-block"><Link className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" to="#">
                  Link
                </Link></li>
                <li className="inline-block"><Link className="px-1 inline-flex items-center gap-2 text-sm font-medium whitespace-nowrap text-primary hover:text-primary" to="#" aria-current="page">
                  Active
                </Link></li>
                <li className="inline-block"><Link className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" to="#">
                  Link
                </Link></li>
                <li className="inline-block"><Link className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-gray-400 pointer-events-none dark:text-white/50" to="#">
                  Disabled
                </Link></li>
              </ul>
            </div>
      ...
      <div className="grid grid-cols-12 gap-x-6">
        ...
        <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <div className="flex">
                <div className="ltr:border-r rtl:border-l border-gray-200 dark:border-white/10">
                  <nav className="flex flex-col space-y-2 whitespace-nowrap" aria-label="Tabs" data-hs-tabs-vertical="true">
                    <button type="button" className="hs-tab-active:bg-white ltr:hs-tab-active:border-r-transparent rtl:hs-tab-active:border-l-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-transparent ltr:dark:hs-tab-active:border-r-gray-800 rtl:dark:hs-tab-active:border-l-gray-800 dark:hs-tab-active:text-primary -mr-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500  ltr:rounded-l-sm rtl:rounded-r-sm hover:text-gray-700 dark:bg-black/20 dark:border-white/10 dark:text-white/70 dark:hover:text-gray-300 active" id="hs-tab-js-vertical-item-1" data-hs-tab="#hs-tab-js-vertical-1" aria-controls="hs-tab-js-vertical-1">
                      Tab 1
                    </button>
                ...
                <div className="">
                  <div id="hs-tab-js-vertical-1" role="tabpanel" aria-labelledby="hs-tab-js-vertical-item-1">
                    <p className="text-gray-500 dark:text-white/70 p-5 border ltr:border-l-0 rtl:border-r-0 rounded-sm ltr:rounded-tl-none rtl:rounded-tr-none dark:border-white/10 border-gray-200">
                      How hotel deals can help you live a better life. How celebrity cruises aren't as bad as you think. How cultural solutions can help you predict the future. How to cheat at dog friendly hotels and get away with it. 17 problems with summer activities. How to cheat at travel agents and get away with it. How not knowing family trip ideas makes you a rookie. What everyone is saying about daily deals. How twitter can teach you about carnival cruises. How to start using cultural solutions.
                    </p>
                  </div>
        ...
        <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <select id="tab-select" className="mb-5 sm:hidden py-2 px-3 ltr:pr-9 rtl:pl-9 block w-full border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70" aria-label="Tabs">
              ...
              <div className="">
                <div id="hs-tab-to-select-1" role="tabpanel" aria-labelledby="hs-tab-to-select-item-1">
                  <p className="text-gray-500 dark:text-white/70 p-5 border rounded-sm  sm:ltr:rounded-tl-none sm:rtl:rounded-tr-none dark:border-white/10 border-gray-200">
                    How hotel deals can help you live a better life. How celebrity cruises aren't as bad as you think. How cultural solutions can help you predict the future. How to cheat at dog friendly hotels and get away with it. 17 problems with summer activities. How to cheat at travel agents and get away with it. How not knowing family trip ideas makes you a rookie. What everyone is saying about daily deals. How twitter can teach you about carnival cruises. How to start using cultural solutions.
                  </p>
                </div>
            ...
            <div className="box-body">
              <div className="sm:border-b-2 border-gray-200 dark:border-white/10">
                <nav className="-mb-0.5 sm:flex sm:space-x-6 rtl:space-x-reverse">
                  <Link className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 dark:text-white/70 hover:text-primary" to="#" id="icon-item-1" data-hs-tab="#icon-1" aria-controls="icon-1">
                  ...
                  <Link className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 dark:text-white/70 hover:text-primary active" to="#" id="icon-item-2" data-hs-tab="#icon-2" aria-controls="icon-2">
                    <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                  ...
                  <Link className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 dark:text-white/70 hover:text-primary" to="#" id="icon-item-3" data-hs-tab="#icon-3" aria-controls="icon-3">
                    <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="sm:border-b border-gray-200 dark:border-white/10">
                <nav className="sm:flex sm:space-x-2" aria-label="Tabs">
                  <button type="button" className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary dark:text-white/70 active" id="tabs-with-badges-item-1" data-hs-tab="#tabs-with-badges-1" aria-controls="tabs-with-badges-1">
                    Tab 1 <span className="hs-tab-active:bg-primary hs-tab-active:text-white dark:hs-tab-active:bg-primary dark:hs-tab-active:text-white ml-1 py-0.5 px-1.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-black/20 dark:text-gray-300">99+</span>
                  </button>
                  <button type="button" className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary dark:text-white/70" id="tabs-with-badges-item-2" data-hs-tab="#tabs-with-badges-2" aria-controls="tabs-with-badges-2">
                    Tab 2 <span className="hs-tab-active:bg-primary hs-tab-active:text-white dark:hs-tab-active:bg-primary dark:hs-tab-active:text-white ml-1 py-0.5 px-1.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-black/20 dark:text-gray-300">99+</span>
                  </button>
            ...
            <div className="box-body">
              <div className="border-b-0 border-gray-200 dark:border-white/10">
                <nav className="flex space-x-2 rtl:space-x-reverse">
                  <Link className="hs-tab-active:!bg-transparent hs-tab-active:!text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500 rounded-t-sm hover:text-gray-700 dark:bg-black/20 dark:border-white/10 dark:text-white/70 dark:hover:text-gray-300 active" to="#" id="card-type-item-1" data-hs-tab="#card-type-1" aria-controls="card-type-1">
                    Active
                  </Link>
                  <Link className="hs-tab-active:!bg-transparent hs-tab-active:!text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500 rounded-t-sm hover:text-gray-700 dark:bg-black/20 dark:border-white/10 dark:text-white/70 dark:hover:text-gray-300" to="#" id="card-type-item-2" data-hs-tab="#card-type-2" aria-controls="card-type-2">
                    Tab 1
                  </Link>
              ...
              <div className="">
                <div id="card-type-1" role="tabpanel" aria-labelledby="card-type-item-1">
                  <p className="text-gray-500 dark:text-white/70 p-5 border rounded-sm ltr:rounded-tl-none rtl:rounded-tr-none dark:border-white/10 border-gray-200">
                    How hotel deals can help you live a better life. How celebrity cruises aren't as bad as you think. How cultural solutions can help you predict the future. How to cheat at dog friendly hotels and get away with it. 17 problems with summer activities. How to cheat at travel agents and get away with it. How not knowing family trip ideas makes you a rookie. What everyone is saying about daily deals. How twitter can teach you about carnival cruises. How to start using cultural solutions.
                  </p>
                </div>
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="sm:flex bg-gray-100 hover:bg-gray-200 rounded-sm transition p-1 dark:bg-black/20 dark:hover:bg-black/20">
                <nav className="sm:flex sm:space-x-2 rtl:space-x-reverse">
                  <Link className="w-full sm:w-auto hs-tab-active:bg-white hs-tab-active:text-gray-700 dark:hs-tab-active:bg-bgdark dark:hs-tab-active:text-white py-2 px-3 inline-flex items-center gap-2 bg-transparent text-sm text-gray-500 hover:text-gray-700 font-medium rounded-sm hover:hover:text-primary dark:text-white/70 dark:hover:text-white active" to="#" id="segment-item-1" data-hs-tab="#segment-1" aria-controls="segment-1">
                    Active
                  </Link>
                  <Link className="w-full sm:w-auto hs-tab-active:bg-white hs-tab-active:text-gray-700 dark:hs-tab-active:bg-bgdark dark:hs-tab-active:text-white py-2 px-3 inline-flex items-center gap-2 bg-transparent text-sm text-gray-500 hover:text-gray-700 font-medium rounded-sm hover:hover:text-primary dark:text-white/70 dark:hover:text-white" to="#" id="segment-item-2" data-hs-tab="#segment-2" aria-controls="segment-2">
                    Link
                  </Link>
                  <Link className="w-full sm:w-auto hs-tab-active:bg-white hs-tab-active:text-gray-700 dark:hs-tab-active:bg-bgdark dark:hs-tab-active:text-white py-2 px-3 inline-flex items-center gap-2 bg-transparent text-sm text-gray-500 hover:text-gray-700 font-medium rounded-sm hover:hover:text-primary dark:text-white/70 dark:hover:text-white" to="#" id="segment-item-3" data-hs-tab="#segment-3" aria-controls="segment-3">
                    Link
                  </Link>
                  <Link className="w-full sm:w-auto hs-tab-active:bg-white hs-tab-active:text-gray-700 dark:hs-tab-active:bg-bgdark dark:hs-tab-active:text-white py-2 px-3 inline-flex items-center gap-2 bg-transparent text-sm text-gray-500 font-medium rounded-sm pointer-events-none dark:text-white/50 dark:hover:text-white" to="#" id="segment-item-4" data-hs-tab="#segment-4">
                    Disabled
                  </Link>
                </nav>
              </div>
