...
const Undermaintenance = () => {
  ...
  return (
    ...
    <html dir='ltr' class="h-full"></html>
          <body class="h-full !py-0 bg-white dark:bg-bgdark"></body>
        </Helmet>
    ...
    <div className="lg:col-span-7 col-span-12">
        <div className="authentication-page w-full">
            <main id="content"  className="w-full max-w-5xl p-6 ">
                <div className="mt-7">
                    <div className="p-0 md:p-7">
                        <div className="text-center">
                            <h1 className="block text-2xl sm:text-5xl font-bold text-gray-800 dark:text-white">Under Maintanace</h1>
                            <p className="mt-3 text-sm text-gray-600 dark:text-white/70">
                                The Site You are looking For is Currently Under Mainatance And it will be back shortly , We will notify you when we are back..!
                            </p>
                        </div>
