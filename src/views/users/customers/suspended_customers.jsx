...
const Suspended_customers = () => {
    ...
    return (
        <div>
            <PageHeader currentpage="Suspended Customers" activepage="Customers" mainpage="Suspended Customers" />
            <div className="box">
                <div className="box-header lg:flex lg:justify-between">
                    <h5 className="box-title my-auto">List Of Suspended Customers</h5>
                </div>
                        ...
                        <table className="ti-custom-table ti-custom-table-head edit-table">
                            <thead className="bg-gray-100 dark:bg-black/20">
                                <tr className="">
                                    ...
                                    <th scope="col" className="dark:text-white/70">Date Suspended</th>
...
export default Suspended_customers;