...
const Sanctioned_customers = () => {
    ...
    return (
        <div>
            <PageHeader currentpage="Sanctioned Customers" activepage="Customers" mainpage="Sanctioned Customers" />
            <div className="box">
                <div className="box-header lg:flex lg:justify-between">
                    <h5 className="box-title my-auto">List Of Sanctioned Customers</h5>
                </div>
                    ...
                    <div className="table-bordered whitespace-nowrap rounded-sm overflow-auto">
                        <table className="ti-custom-table ti-custom-table-head edit-table">
                            <thead className="bg-gray-100 dark:bg-black/20">
                                <tr className="">
                                    <th scope="col" className="dark:text-white/70">Customer No.</th>
                                    <th scope="col" className="dark:text-white/70">Customer Name</th>
                                    <th scope="col" className="dark:text-white/70">Customer Email</th>
                                    <th scope="col" className="dark:text-white/70">Customer Phone Number</th>
                                    <th scope="col" className="dark:text-white/70">Date Created</th>
                                    <th scope="col" className="dark:text-white/70">Date Sanctioned</th>
...
export default Sanctioned_customers;