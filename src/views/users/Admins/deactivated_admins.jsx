...
const Deactivated_admins = () => {
    ...
    return (
        <div>
            <PageHeader currentpage="Deactivated Admins" activepage="Admins" mainpage="Deactivated Admins" />
            <div className="box">
                <div className="box-header lg:flex lg:justify-between">
                    <h5 className="box-title my-auto">List Of Deactivated Admins</h5>
...
export default Deactivated_admins;