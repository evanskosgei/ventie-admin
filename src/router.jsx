      ...
      {RouteData.map((idx) => (
        <Fragment key={Math.random()}>
          ...
          <Route path={`${import.meta.env.BASE_URL}`} element={<Authenticationlayout />}>
            ...
            />
            <Route
              path={`${import.meta.env.BASE_URL}Authentication/createpassword/cover1`}
            ...
            />
            <Route
              path={`${import.meta.env.BASE_URL}Authentication/forgetpassword/cover1`}
              element={<ForgetPasswordCover1 />}
            />
            <Route
              path={`${import.meta.env.BASE_URL}Authentication/forgetpassword/cover2`}
            ...
            />
            <Route
              path={`${import.meta.env.BASE_URL}Authentication/resetpassword/basic`}
              element={<ResetPasswordBasic />}
            />
            <Route
              path={`${import.meta.env.BASE_URL}Authentication/resetpassword/cover1`}
