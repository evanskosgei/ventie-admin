                  ...
                  >
                    ...
                    >
                      <div className="ti-dropdown-header !bg-primary border-b dark:border-white/10 flex justify-between items-center">
                        ...
                        <Link to="#" className="badge bg-black/20 text-white rounded-sm" id="cart-data">
                          4 Items
                        </Link>
                      </div>
                      <div className="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                        <div className="py-2 first:pt-0 last:pb-0" id="allCartsContainer">
                          {allData.map((idx) => (
                            <div className="ti-dropdown-item relative header-box" key={Math.random()}>
                              <Link
                                to={`${import.meta.env.BASE_URL}pagecomponent/Ecommerce/cart/`}
                        ...
                        <div className="py-2 first:pt-0 px-5">
                          <Link
                            ...
                            to={`${import.meta.env.BASE_URL}pagecomponent/Ecommerce/checkout/`}
                          >
                            Proceed Checkout
                          </Link>
                        </div>
                    ...
                    >
                      ...
                      <div className="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                        <div className="grid grid-cols-3 gap-0 p-4 pt-2">
                          ...
                          <Link
                            to={`${import.meta.env.BASE_URL}pagecomponent/mail/chat/`}
                            className="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20"
                          >
                          ...
                          <Link
                            to={`${import.meta.env.BASE_URL}pagecomponent/tasks/`}
                            className="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20"
                          >
                          ...
                          <Link
                            to={`${import.meta.env.BASE_URL}advancedUi/calender/`}
                            className="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20"
                          >
                          ...
                          <Link
                            to={`${import.meta.env.BASE_URL}advancedUi/filemanager/filemanagermain/`}
                            className="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20"
                          >
                          ...
                          <Link
                            to={`${import.meta.env.BASE_URL}pagecomponent/contacts/`}
                            className="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20"
                          >
